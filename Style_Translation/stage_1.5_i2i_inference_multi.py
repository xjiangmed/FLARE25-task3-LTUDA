...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="/home/xjiangbh/FLARE_work/FLARE25-task3-LTUDA/Style_Translation/CT2MRI/i2i_checkpoints/enc_0066.pt",
    )
    parser.add_argument(
        "--source_npy_dirpath",
        type=str,
        default="/nfs/scratch/xjiangbh/FLARE/large-scale-data/CT/CT_3d/",
    )
    parser.add_argument(
        "--target_npy_dirpath",
        type=str,
        default="/nfs/scratch/xjiangbh/FLARE/large-scale-data/MRI/Training/MRI_3d/",
    )
    parser.add_argument(
        "--save_nii_dirpath",
        type=str,
        default="/nfs/scratch/xjiangbh/FLARE/large-scale-data/CT/CT2MR_image/",
    )
