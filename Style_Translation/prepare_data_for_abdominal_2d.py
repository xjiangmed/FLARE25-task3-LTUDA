...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------------------
    data_root = "/nfs/scratch/xjiangbh/FLARE/GAN-data/CT/CT_image/"
    save_path = "/nfs/scratch/xjiangbh/FLARE/GAN-data/CT/CT_2d/"
    ...
    for image_id in img_files:
        ...
        print(f"source shape: {source_slices.shape}")  # 输出 [N, 512, 512]
    ...
    # ------------------------------------------------------------------
    MRI_data_root = "/nfs/scratch/xjiangbh/FLARE/GAN-data/MRI/MRI_image/"
    MRI_save_path = "/nfs/scratch/xjiangbh/FLARE/GAN-data/MRI/MRI_2d/"
    ...
    # ------------------------------------------------------------------
    PET_data_root = "/nfs/scratch/xjiangbh/FLARE/GAN-data/PET/PET_image/"
    PET_save_path = "/nfs/scratch/xjiangbh/FLARE/GAN-data/PET/PET_2d/"
