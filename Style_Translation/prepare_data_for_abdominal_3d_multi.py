...
if __name__ == "__main__":
    ...
    # 配置参数
    config = {
        "data_root": "/nfs/scratch/xjiangbh/FLARE/large-scale-data/CT/CT_image/",
        "save_path": "/nfs/scratch/xjiangbh/FLARE/large-scale-data/CT/CT_3d/",
        "label_root": "/nfs/scratch/xjiangbh/FLARE/large-scale-data/CT/CT_label/",
        "label_save_path": "/nfs/scratch/xjiangbh/FLARE/large-scale-data/CT/CT2MR_label/",
        "target_spacing": (1.0, 1.0)
    }
    
    # config = {
    #     "data_root": "/nfs/scratch/xjiangbh/FLARE/large-scale-data/MRI/Training/MRI_image/",
    #     "save_path": "/nfs/scratch/xjiangbh/FLARE/large-scale-data/MRI/Training/MRI_3d/",
    #     "label_root": None,
    ...
    # config = {
    #     "data_root": "/nfs/scratch/xjiangbh/FLARE/large-scale-data/PET/Training/PET_image/",
    #     "save_path": "/nfs/scratch/xjiangbh/FLARE/large-scale-data/PET/Training/PET_3d/",
    #     "label_root": None,
    #     "label_save_path": None,
    #     "target_spacing": (1.0, 1.0)
    # }
