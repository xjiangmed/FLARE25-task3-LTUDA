...
# PET data
save_dir = "/nfs/scratch/xjiangbh/FLARE/GAN-data/PET/PET_image/"
PET_dir = "/nfs/scratch/xjiangbh/FLARE/FLARE-Task3-DomainAdaption/train_PET_unlabeled/"
...
# CT data
save_dir = "/nfs/scratch/xjiangbh/FLARE/GAN-data/CT/CT_image/"
CT_dir1 = "/nfs/scratch/xjiangbh/FLARE/FLARE-Task3-DomainAdaption/train_CT_gt_label/imagesTr/"
for sf in os.listdir(CT_dir1): # 50 cases
    src_path = os.path.join(CT_dir1, sf)
    dst_path = os.path.join(save_dir, sf)
    shutil.copy(src_path, dst_path)

CT_dir2 = "/nfs/scratch/xjiangbh/FLARE/FLARE-Task3-DomainAdaption/train_CT_pseudolabel/imagesTr/" 
...
# MRI data
save_dir = "/nfs/scratch/xjiangbh/FLARE/GAN-data/MRI/MRI_image/"
