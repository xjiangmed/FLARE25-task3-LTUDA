...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='CT2MRI')
    parser.add_argument('--seed', type=int, default=10)
    parser.add_argument('--source_path', type=str, default='/nfs/scratch/xjiangbh/FLARE/small-scale-data/CT/CT_2d')
    parser.add_argument('--target_path', type=str, default='/nfs/scratch/xjiangbh/FLARE/small-scale-data/MRI/Training/MRI_2d')
